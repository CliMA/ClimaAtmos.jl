...
/sw/openmpi-5.0.5/bin/mpiexec -n 128 julia --project=.buildkite .buildkite/ci_driver.jl --config_file config/longrun_configs/longrun_moist_baroclinic_wave_scaling_${SLURM_ARRAY_TASK_ID}.yml
