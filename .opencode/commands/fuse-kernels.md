...
Try to follow the workflow below and heed the advice section and respect the constraints.

The goal is to reduce number of kernels in target function and reduce its execution time on a GPU.
