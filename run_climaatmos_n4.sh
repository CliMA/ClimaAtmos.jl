...
#SBATCH --output=slurm_outputs/n4_out-%j_%a.txt
#SBATCH --error=slurm_outputs/n4_err-%j_%a.txt
...
/sw/openmpi-5.0.5/bin/mpiexec -n 4 julia --project=.buildkite .buildkite/ci_driver.jl --config_file config/longrun_configs/longrun_moist_baroclinic_wave_scaling_${SLURM_ARRAY_TASK_ID}.yml
