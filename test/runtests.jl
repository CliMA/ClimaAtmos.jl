...
if TEST_GROUP in ("parameterizations", "all")
    ...
    # Gravity wave. test_beres_unit.jl is pure-function; test_ad99_momentum_budget.jl
    # builds one single column and checks that the AD99 scheme deposits exactly the
    # momentum it launches. The heavier simulation-based Beres tests
    ...
    @safetestset "AD99 NOGW momentum budget" begin @time include("parameterized_tendencies/gravity_wave/non_orographic_gravity_wave/test_ad99_momentum_budget.jl") end
