...
# ============================================================================
# ============================================================================
# Dynamics: the prognostic equations, split in two groups against the
# 90-minute job timeout. Together the ten files took 75 to 92 minutes on
# GitHub's runners, and a job cancelled at the limit reports as failed while
# never running the files that had not started. The EDMFX diffusion files
# build a fresh EDMFX model per configuration, which compiles the whole
# tendency pipeline again each time, so they carry the bulk of the compile
# time and get a group of their own.
