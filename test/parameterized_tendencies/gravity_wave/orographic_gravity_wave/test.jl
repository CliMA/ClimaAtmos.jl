...
li_hmax =
    linear_interpolation((hr_lon, hr_lat), hr_hmax, extrapolation_bc = (Periodic(), Flat()))
...
p1 = contourf(
    ...
    gfdl_lat,
    gfdl_hmax',
    clim = (-max_abs_gfdl_hmax, max_abs_gfdl_hmax),
    color = :balance,
    title = "GFDL hmax",
);
p2 = contourf(
    ...
    hr_lat,
    hr_hmax',
    clim = (-max_abs_hr_hmax, max_abs_hr_hmax),
    color = :balance,
    title = "HR hmax",
);
p = plot(p1, p2, layout = (2, 1), size = (1500, 1600));
...
p1 = contourf(
    gfdl_lon[gfdl_lon_idx],
    gfdl_lat[gfdl_lat_idx],
    gfdl_t11'[gfdl_lat_idx, gfdl_lon_idx],
    color = :balance,
    title = "GFDL t11",
);
...
p1 = heatmap(
    ...
    gfdl_lat,
    gfdl_t11_aligned',
    clim = (-max_abs_gfdl_t11, max_abs_gfdl_t11),
    color = :balance,
    title = "GFDL t11",
);
p2 = heatmap(
...
p1 = heatmap(
    ...
    gfdl_lat,
    gfdl_t12_aligned',
    clim = (-max_abs_gfdl_t12, max_abs_gfdl_t12),
    color = :balance,
    title = "GFDL t12",
);
p2 = heatmap(
...
p1 = heatmap(
    ...
    gfdl_lat,
    gfdl_t21_aligned',
    clim = (-max_abs_gfdl_t21, max_abs_gfdl_t21),
    color = :balance,
    title = "GFDL t21",
);
p2 = heatmap(
...
p1 = heatmap(
    ...
    gfdl_lat,
    gfdl_t22_aligned',
    clim = (-max_abs_gfdl_t22, max_abs_gfdl_t22),
    color = :balance,
    title = "GFDL t22",
);
p2 = heatmap(
