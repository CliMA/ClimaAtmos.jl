...
- `include("artifact_funcs.jl")` for `ogwd_computed_drag_h8_path` / `ogwd_computed_drag_h16_path`
"""
...
function load_computed_drag(parsed_args, comms_ctx)
    ...
    @info "Local file not found, loading computed drag from artifact..."
    ...
    @info "Loading from artifact: $(artifact_path)"
