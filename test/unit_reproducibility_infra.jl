...
@testset "Reproducibility infrastructure: move_data_to_save_dir legacy folder structure" begin
    mktempdir2_cd_computed() do (save_dir, computed_dir)
        ...
        put_data_file(job_id_1, fv, comms_ctx; filename = "ref_prog_state.hdf5")
        put_data_file(job_id_2, fv, comms_ctx; filename = "ref_prog_state.hdf5")
        ...
        @test isfile(
            joinpath(save_dir, "hash_new", "job_id_1", "ref_prog_state.hdf5"),
        )
        @test isfile(
            joinpath(save_dir, "hash_new", "job_id_2", "ref_prog_state.hdf5"),
        )
