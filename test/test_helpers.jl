...
function create_mock_era5_datasets(
    ...
    tvforcing["q"][:, :, :, :] .= shum_from_geopotential(tvforcing["z"])
    close(tvforcing)
...
"""
    shum_from_geopotential(geopotential_levels; q0 = 0.02, shum_scale_height = 2e4)
...
The default values are a 2% mixing ratio at the surface and approximately a 2km scale height.
"""
function shum_from_geopotential(geopotential_levels; q0 = 0.02, shum_scale_height = 2e4)
    return q0 .* exp.(.-geopotential_levels ./ shum_scale_height)
end
