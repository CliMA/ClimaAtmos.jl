...
cloud-resolving simulations in Cartesian domains to global weather and climate
simulations on the sphere [Yatunin2026](@cite).
...
## What the model does
  ...
  - **A model to cross scales.** ClimaAtmos solves the fully compressible
    ...
    cloud-resolving simulations, and on the sphere, for global weather and
    climate simulations.
