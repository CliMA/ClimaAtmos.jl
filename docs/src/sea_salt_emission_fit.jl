...
# Gong (2003) dimensionless number spectrum dF/dr̂ at u_10 = 1 m/s, 
# eq. (2), with Θ = 30.
function gong2003_spectrum(r_hat; theta = 30.0)
...
skill = SeaSaltFitSkill.skill(stored_modes, r_hat_edges)
println(
...
r_plot = exp10.(range(log10(0.03), log10(20), 400))
...
ax = Axis(
    ...
    xscale = log10,
    yscale = log10,
    xlabel = "radius r̂ = r/r_ref (r_ref = $(round(r_ref * 1e6; sigdigits = 3)) μm)",
