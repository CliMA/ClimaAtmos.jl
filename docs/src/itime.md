...
Dates derived from an inaccurate simulation time are wrong, and diagnostics
keyed to those dates are written at the wrong times. Counting integer periods
...
!!! note "Converting an ITime to a float gives Float64"
