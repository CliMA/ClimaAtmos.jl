...
```
julia --project=.buildkite examples/hybrid/driver.jl --config_file path_to_mysim.yml
```
...
```
julia -i --project=.buildkite examples/hybrid/driver.jl --config_file filepath
```
