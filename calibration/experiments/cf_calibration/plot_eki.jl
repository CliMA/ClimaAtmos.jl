...
output_dir = "/resnick/groups/esm/jschmitt/climaatmos_scm_calibrations/output_cf_ml_v1/exp3_quadrature_sgs_physonly"
iterations = 0:10
# iterations = nothing
...
# use nn prior if calibrating nn parameters
