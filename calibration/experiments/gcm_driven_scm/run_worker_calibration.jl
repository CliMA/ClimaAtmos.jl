...
# addprocs(SlurmManager(5), t="01:30:00", cpus_per_task=3,exeflags="--project=$(Base.active_project())")
...
@everywhere begin
    ...
    (; output_dir, prior_path, model_config, z_max, norm_factors_by_var) = experiment_config_nt
