...
precipitation, chemistry, and aerosol variables are appended by `moisture_variables`,
`precip_variables`, `chemistry_variables`, and `aerosol_variables`, which may each contribute
nothing.
"""
...
species_aerosol_variables(ρ, ::Nothing) = (;)
...
species_aerosol_sgs_variables(physical_state, ::Nothing) = (;)
