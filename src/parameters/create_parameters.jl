...
microphys_1m_parameters(::Type{FT}; options_kwargs...) where {FT <: AbstractFloat} =
    microphys_1m_parameters(CP.create_toml_dict(FT); options_kwargs...)

microphys_1m_parameters(toml_dict::CP.ParamDict; options_kwargs...) =
    CM.Parameters.Microphysics1MParams(toml_dict; options_kwargs...)

microphys_2m_parameters(::Type{FT}; options_kwargs...) where {FT <: AbstractFloat} =
    microphys_2m_parameters(CP.create_toml_dict(FT); options_kwargs...)

microphys_2m_parameters(toml_dict::CP.ParamDict; options_kwargs...) =
    CM.Parameters.Microphysics2MParams(toml_dict; with_ice = true, options_kwargs...)
