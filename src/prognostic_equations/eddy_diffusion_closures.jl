...
Returns an `EddyViscosityDiffusivity` struct containing K_u and K_h in units of [m^2/s].
"""
function eddy_viscosity_diffusivity(
    turbconv_params,
    tke,
    mixing_length,
    prandtl_nvec,
    ...
    return EddyViscosityDiffusivity(K_u, K_h)
end