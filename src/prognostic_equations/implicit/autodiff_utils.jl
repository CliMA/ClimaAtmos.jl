# TODO: Move this bugfix into ClimaCore.
Spaces.issubspace(
    column_space::Spaces.FiniteDifferenceSpace{<:Grids.ColumnGrid},
    extruded_space::Spaces.ExtrudedFiniteDifferenceSpace,
) = Spaces.grid(column_space).full_grid === Spaces.grid(extruded_space)
