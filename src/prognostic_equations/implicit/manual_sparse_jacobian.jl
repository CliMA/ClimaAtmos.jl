...
here. The diffusive enthalpy flux is differentiated in its decomposed form
`F_h = -K_h ∇s_d + Σ_μ h_tot,μ (-K_h ∇q_μ)`, holding the `h_tot,μ` prefactors,
the equilibrium condensate partition, and the diffusivities fixed. The
