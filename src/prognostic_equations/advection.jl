    ...
    for j in 1:n
        ...
        if p.atmos.moisture_model isa NonEquilMoistModel &&
           p.atmos.microphysics_model isa Microphysics1Moment
            ...
            ᶠwₗ³ʲs =
                (@. lazy(CT3(ᶠinterp(Geometry.WVector(-1 * ᶜwₗʲs.:($$j))))))
            ᶠwᵢ³ʲs =
                (@. lazy(CT3(ᶠinterp(Geometry.WVector(-1 * ᶜwᵢʲs.:($$j))))))
            ᶠwᵣ³ʲs =
                (@. lazy(CT3(ᶠinterp(Geometry.WVector(-1 * ᶜwᵣʲs.:($$j))))))
            ᶠwₛ³ʲs =
                (@. lazy(CT3(ᶠinterp(Geometry.WVector(-1 * ᶜwₛʲs.:($$j))))))
            ...
            ᶜmseₗ = (@. lazy(
                Y.c.sgsʲs.:($$j).q_liq * (
                    TD.internal_energy_liquid(thp, ᶜtsʲs.:($$j)) +
                    TD.gas_constant_air(thp, ᶜtsʲs.:($$j)) *
            ...
            ᶜmseᵢ = (@. lazy(
                Y.c.sgsʲs.:($$j).q_ice * (
                    TD.internal_energy_ice(thp, ᶜtsʲs.:($$j)) +
                    TD.gas_constant_air(thp, ᶜtsʲs.:($$j)) *
                    TD.air_temperature(thp, ᶜtsʲs.:($$j)) +
                    ᶜΦ
                ),
            ...
            ᶜ∂ρ̂∂zₗ = (@. lazy(
                upwind_biased_grad(
                    -1 * Geometry.WVector(ᶜwₗʲs.:($$j)),
                    Y.c.sgsʲs.:($$j).ρa,
                ),
            ))
            ᶜ∂ρ̂∂zᵢ = (@. lazy(
                upwind_biased_grad(
                    -1 * Geometry.WVector(ᶜwᵢʲs.:($$j)),
                    Y.c.sgsʲs.:($$j).ρa,
                ),
            ))
            ᶜ∂ρ̂∂zᵣ = (@. lazy(
                upwind_biased_grad(
                    -1 * Geometry.WVector(ᶜwᵣʲs.:($$j)),
                    Y.c.sgsʲs.:($$j).ρa,
                ),
            ))
            ᶜ∂ρ̂∂zₛ = (@. lazy(
                upwind_biased_grad(
                    -1 * Geometry.WVector(ᶜwₛʲs.:($$j)),
                    Y.c.sgsʲs.:($$j).ρa,
                ),
            ))
            ...
            @. Yₜ.c.sgsʲs.:($$j).q_tot -=
                dot(
                    ᶜinv_ρ̂ * ᶜ∂ρ̂∂zₗ,
                    CT3(Geometry.WVector(-1 * ᶜwₗʲs.:($$j))),
                ) *
                Y.c.sgsʲs.:($$j).q_liq *
                (1 - Y.c.sgsʲs.:($$j).q_tot)
            @. Yₜ.c.sgsʲs.:($$j).q_liq -=
            ...
            @. Yₜ.c.sgsʲs.:($$j).mse -=
                dot(
                    ᶜinv_ρ̂ * ᶜ∂ρ̂∂zₗ,
                    CT3(Geometry.WVector(-1 * ᶜwₗʲs.:($$j))),
                ) * (Y.c.sgsʲs.:($$j).q_liq * Y.c.sgsʲs.:($$j).mse - ᶜmseₗ)

            @. Yₜ.c.sgsʲs.:($$j).q_tot -=
                dot(
                    ᶜinv_ρ̂ * ᶜ∂ρ̂∂zᵢ,
                    CT3(Geometry.WVector(-1 * ᶜwᵢʲs.:($$j))),
                ) *
                Y.c.sgsʲs.:($$j).q_ice *
                (1 - Y.c.sgsʲs.:($$j).q_tot)
            @. Yₜ.c.sgsʲs.:($$j).q_ice -=
            ...
            @. Yₜ.c.sgsʲs.:($$j).mse -=
                dot(
                    ᶜinv_ρ̂ * ᶜ∂ρ̂∂zᵢ,
                    CT3(Geometry.WVector(-1 * ᶜwᵢʲs.:($$j))),
                ) * (Y.c.sgsʲs.:($$j).q_ice * Y.c.sgsʲs.:($$j).mse - ᶜmseᵢ)

            @. Yₜ.c.sgsʲs.:($$j).q_tot -=
                dot(
                    ᶜinv_ρ̂ * ᶜ∂ρ̂∂zᵣ,
                    CT3(Geometry.WVector(-1 * ᶜwᵣʲs.:($$j))),
                ) *
                Y.c.sgsʲs.:($$j).q_rai *
                (1 - Y.c.sgsʲs.:($$j).q_tot)
            @. Yₜ.c.sgsʲs.:($$j).q_rai -=
            ...
            @. Yₜ.c.sgsʲs.:($$j).mse -=
                dot(
                    ᶜinv_ρ̂ * ᶜ∂ρ̂∂zᵣ,
                    CT3(Geometry.WVector(-1 * ᶜwᵣʲs.:($$j))),
                ) * (Y.c.sgsʲs.:($$j).q_rai * Y.c.sgsʲs.:($$j).mse - ᶜmseᵣ)

            @. Yₜ.c.sgsʲs.:($$j).q_tot -=
                dot(
                    ᶜinv_ρ̂ * ᶜ∂ρ̂∂zₛ,
                    CT3(Geometry.WVector(-1 * ᶜwₛʲs.:($$j))),
                ) *
                Y.c.sgsʲs.:($$j).q_sno *
                (1 - Y.c.sgsʲs.:($$j).q_tot)
            @. Yₜ.c.sgsʲs.:($$j).q_sno -=
            ...
            @. Yₜ.c.sgsʲs.:($$j).mse -=
                dot(
                    ᶜinv_ρ̂ * ᶜ∂ρ̂∂zₛ,
                    CT3(Geometry.WVector(-1 * ᶜwₛʲs.:($$j))),
                ) * (Y.c.sgsʲs.:($$j).q_sno * Y.c.sgsʲs.:($$j).mse - ᶜmseₛ)
