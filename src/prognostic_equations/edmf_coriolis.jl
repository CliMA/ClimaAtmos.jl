...
edmf_coriolis_cache(Y, edmf_coriolis::Nothing) = (; edmf_coriolis)
function edmf_coriolis_cache(Y, edmf_coriolis::EDMFCoriolis)
    ...
    return (; edmf_coriolis, ᶜuₕ_g = similar(Y.c.uₕ), ᶜf_coriolis)
end
...
function edmf_coriolis_tendency!(
    ...
    ᶜf_coriolis = p.ᶜf_coriolis[colidx]
    ᶜuₕ_g = p.ᶜuₕ_g[colidx]
