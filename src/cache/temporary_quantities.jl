...
function temporary_quantities(Y, atmos)
    ...
    return (;
        ...
        tmp_evap = Fields.Field(FT, center_space), # tmp tendecy diagnostics for debugging
        tmp_melt = Fields.Field(FT, center_space),
        tmp_dep_sub = Fields.Field(FT, center_space),
        tmp_accr_sno_ice = Fields.Field(FT, center_space),
        tmp_accr_rai_liq = Fields.Field(FT, center_space),
        tmp_acnv_ice_sno = Fields.Field(FT, center_space),
        tmp_acnv_liq_rai = Fields.Field(FT, center_space),
        tmp_accr_sno_liq_sno_part = Fields.Field(FT, center_space),
