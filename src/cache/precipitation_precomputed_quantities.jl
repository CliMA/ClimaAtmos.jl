...
function set_precipitation_surface_fluxes!(
    ...
    sfc_qᵣ = Fields.Field(
        Fields.field_values(Base.materialize(Fields.level(ᶜq_rai, 1))),
        sfc_space,
    )
    sfc_qₛ = Fields.Field(
        Fields.field_values(Base.materialize(Fields.level(ᶜq_sno, 1))),
        sfc_space,
    )
    sfc_qₗ = Fields.Field(
        Fields.field_values(Base.materialize(Fields.level(ᶜq_liq, 1))),
        sfc_space,
    )
    sfc_qᵢ = Fields.Field(
        Fields.field_values(Base.materialize(Fields.level(ᶜq_ice, 1))),
        sfc_space,
    )
