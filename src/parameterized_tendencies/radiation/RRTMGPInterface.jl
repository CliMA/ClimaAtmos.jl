...
Base.@kwdef struct GrayRadiation <: AbstractRRTMGPMode
    add_isothermal_boundary_layer::Bool = true
    deep_atmosphere::Bool = true
end
Base.@kwdef struct ClearSkyRadiation <: AbstractRRTMGPMode
    idealized_h2o::Bool = false
    add_isothermal_boundary_layer::Bool = true
    aerosol_radiation::Bool = false
    deep_atmosphere::Bool = true
end
Base.@kwdef struct AllSkyRadiation{ACR <: Union{Nothing, AbstractCloudInRadiation}} <:
                   AbstractRRTMGPMode
    idealized_h2o::Bool = false
...
Base.@kwdef struct AllSkyRadiationWithClearSkyDiagnostics{
