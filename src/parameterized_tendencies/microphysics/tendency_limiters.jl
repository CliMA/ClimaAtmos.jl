...
# The 2M+P3 substepped saturation-adjustment averaging is the `SubsteppedAverage`
# mode of `CloudMicrophysics.bulk_microphysics_tendencies`. The per-cell limiters
# (`coupled_sink_limit_factor`, `apply_2m_tendency_limits!`) support the
# per-RK-stage EDMF path.
