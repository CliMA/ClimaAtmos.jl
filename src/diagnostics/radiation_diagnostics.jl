...
function compute_rlu!(
    ...
    if isnothing(out)
        return RRTMGPI.array2field(
            FT.(cache.atmos.radiation.radiation_model.face_lw_flux_up),
            axes(state.f),
        )
    else
        out .= RRTMGPI.array2field(
...
function compute_rsdcs!(
    ...
    if isnothing(out)
        return RRTMGPI.array2field(
            FT.(cache.atmos.radiation.radiation_model.face_clear_sw_flux_dn),
            axes(state.f),
        )
    else
        out .= RRTMGPI.array2field(
...
function compute_rsucs!(
    ...
    if isnothing(out)
        return RRTMGPI.array2field(
            FT.(cache.atmos.radiation.radiation_model.face_clear_sw_flux_up),
            axes(state.f),
        )
    else
        out .= RRTMGPI.array2field(
...
function compute_rldcs!(
    ...
    if isnothing(out)
        return RRTMGPI.array2field(
            FT.(cache.atmos.radiation.radiation_model.face_clear_lw_flux_dn),
            axes(state.f),
        )
    else
        out .= RRTMGPI.array2field(
...
function compute_rlucs!(
    ...
    if isnothing(out)
        return RRTMGPI.array2field(
            FT.(cache.atmos.radiation.radiation_model.face_clear_lw_flux_up),
            axes(state.f),
        )
    else
        out .= RRTMGPI.array2field(
