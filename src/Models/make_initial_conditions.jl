...
"""
function make_initial_conditions(
    model::ShallowWaterModel{<:AbstractHorizontalDomain},
)
...
"""
function make_initial_conditions(
    model::SingleColumnModel{<:AbstractVerticalDomain},
)
    ...
    y_centers =
        model.initial_conditions.centers.(z_centers, Ref(model.parameters))
