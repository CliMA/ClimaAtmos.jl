...
function weather_model_data_path(start_date, target_levels)
    ...
    #     "era5_raw_$(start_date_str)_$(start_time).nc",
    # )
    ic_data_path = "/glade/campaign/univ/ucit0011/cchristo/wxquest_ics/era5_init_processed_internal_$(start_date_str)_0000.nc"
    raw_data_path = "/glade/campaign/univ/ucit0011/cchristo/wxquest_ics/era5_raw_$(start_date_str)_0000.nc"
