    ...
    if area > 0
        ...
        if precip_model isa Microphysics1Moment
            ...
            S_qt_rain =
                -min(
                    q.liq / Δt,
                    CM1.conv_q_liq_to_q_rai(microphys_params, q.liq),
                )
            S_qt_snow =
                -min(
                    q.ice / Δt,
            ...
            θ_liq_ice_tendency -=
                1 / Π_m / c_pm * (L_v0 * S_qt_rain + L_s0 * S_qt_snow)
            ...
            if T < T_fr # cloud droplets freeze to become snow)
                ...
                θ_liq_ice_tendency +=
                    S_qt / Π_m / c_pm * (Lf * (1 + Rm / c_vm) * α - L_v0)
            ...
            θ_liq_ice_tendency -=
                1 / Π_m / c_pm * (S_qr * Lf * (1 + Rm / c_vm) + S_qt * L_s0)
            e_tot_tendency += S_qt * (I_i + Φ)
