...
# ---------------------------------------------------------------------------
# Minimal setup to call `set_microphysics_tendency_cache!` at the bottom of
# this file.
#
...
# just that step. It reads only the thermodynamic / microphysics parts of
...
BenchmarkTools.@benchmark CUDA.@sync CA.set_microphysics_tendency_cache!(
           $Y,
           $p,
           $(p.atmos.microphysics_model),
           $(p.atmos.turbconv_model),
