...
"""
function generate_spaces(; h_elem = 60, diffiter = 32)
    FT = Float32
...
"""
    remap_to_array(var, hcoords)
Given an Array of `hcoords`, this function remaps a ClimaCore
Field `var` onto `hcoords`. 
Returns an `Array` containing the values which make up `var`.
"""
...
"""
    gen_spectra(var)
Given a Field `var`, this function first calls `remap_to_array`
