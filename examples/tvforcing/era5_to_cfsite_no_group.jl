...
ds = Dataset("sim_forcing_site23_ng_xyz.nc", "c")
...
time_values =
    Float64.(Dates.value.(sim_forcing["time"] .- time_ref) ./ (1e3 * 60 * 60)) # hours since 1970-01-01 00:00:00
