...
all_best_mse["sphere_ssp_baroclinic_wave_rhoe_equilmoist"][(:f, :u₃, :components, :data, 1)] = 0
#
...
all_best_mse["sphere_first_upwind_tracer_energy_ssp_baroclinic_wave_rhoe_equilmoist"][(:f, :u₃, :components, :data, 1)] = 0
#
...
all_best_mse["sphere_third_upwind_tracer_energy_ssp_baroclinic_wave_rhoe_equilmoist"][(:f, :u₃, :components, :data, 1)] = 0
#
...
all_best_mse["sphere_ssp_held_suarez_rhoe_equilmoist_hightop_sponge"][(:f, :u₃, :components, :data, 1)] = 0
#
...
all_best_mse["sphere_aquaplanet_rhoe_equilmoist_allsky_gw"][(:f, :u₃, :components, :data, 1)] = 0
#
