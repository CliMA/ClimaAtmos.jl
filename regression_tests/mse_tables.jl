...
all_best_mse["sphere_baroclinic_wave_rhoe"][(:f, :u₃, :components, :data, 1)] = 0.0
#
...
all_best_mse["sphere_baroclinic_wave_rhoe_equilmoist"][(:f, :u₃, :components, :data, 1)] = 0.0
#
...
all_best_mse["sphere_ssp_baroclinic_wave_rhoe_equilmoist"][(:f, :u₃, :components, :data, 1)] = 0.0
#
...
all_best_mse["sphere_first_upwind_tracer_energy_ssp_baroclinic_wave_rhoe_equilmoist"][(:f, :u₃, :components, :data, 1)] = 0.0
#
...
all_best_mse["sphere_third_upwind_tracer_energy_ssp_baroclinic_wave_rhoe_equilmoist"][(:f, :u₃, :components, :data, 1)] = 0.0
#
...
all_best_mse["sphere_held_suarez_rhotheta"][(:f, :u₃, :components, :data, 1)] = 0.0
#
...
all_best_mse["sphere_held_suarez_rhoe_hightop"][(:f, :u₃, :components, :data, 1)] = 0.0
#
...
all_best_mse["sphere_held_suarez_rhoe_equilmoist_hightop_sponge"][(:f, :u₃, :components, :data, 1)] = 0.0
#
...
all_best_mse["sphere_ssp_held_suarez_rhoe_equilmoist_hightop_sponge"][(:f, :u₃, :components, :data, 1)] = 0.0
#
all_best_mse["sphere_aquaplanet_rhoe_equilmoist_allsky_gw_res"] = OrderedCollections.OrderedDict()
all_best_mse["sphere_aquaplanet_rhoe_equilmoist_allsky_gw_res"][(:c, :ρ)] = 0.0
all_best_mse["sphere_aquaplanet_rhoe_equilmoist_allsky_gw_res"][(:c, :uₕ, :components, :data, 1)] = 0.0
all_best_mse["sphere_aquaplanet_rhoe_equilmoist_allsky_gw_res"][(:c, :uₕ, :components, :data, 2)] = 0.0
all_best_mse["sphere_aquaplanet_rhoe_equilmoist_allsky_gw_res"][(:c, :ρe_tot)] = 0.0
...
all_best_mse["sphere_aquaplanet_rhoe_equilmoist_allsky_gw_raw"][(:c, :ρ)] = 0.368392059246862
all_best_mse["sphere_aquaplanet_rhoe_equilmoist_allsky_gw_raw"][(:c, :uₕ, :components, :data, 1)] = 805964.6886908296
all_best_mse["sphere_aquaplanet_rhoe_equilmoist_allsky_gw_raw"][(:c, :uₕ, :components, :data, 2)] = 1.3045948104340408e6
all_best_mse["sphere_aquaplanet_rhoe_equilmoist_allsky_gw_raw"][(:c, :ρe_tot)] = 29.630841248478678
all_best_mse["sphere_aquaplanet_rhoe_equilmoist_allsky_gw_raw"][(:c, :ρq_tot)] = 43988.74760514929
all_best_mse["sphere_aquaplanet_rhoe_equilmoist_allsky_gw_raw"][(:f, :u₃, :components, :data, 1)] = 2.0091481790161123e6
#
...
all_best_mse["single_column_nonorographic_gravity_wave"][(:f, :u₃, :components, :data, 1)] = 0.0
#
#! format: on
#################################
#################################
